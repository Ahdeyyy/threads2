...
<form action="" method="post" use:enhance>
	<Card class="w-2/3 mx-auto shadow-2xl">
		...
		<CardFooter class="grid grid-flow-row gap-2">
			<Button class="w-full py-4 px-14 rounded-3xl">sign in</Button>
			<p class="py-4 px-14 text-center">
				Don't have an account? <Button href="/signup" variant="link">sign up</Button>
			</p>
		</CardFooter>
	</Card>
</form>
